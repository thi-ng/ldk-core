...
* Namespace: thi.ng.sema.query.expressions
#+BEGIN_SRC clojure :tangle ../babel/src/cljx/thi/ng/sema/query/expressions.cljx :mkdirp yes :padline no
  (ns thi.ng.sema.query.expressions
    (:require
