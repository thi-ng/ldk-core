...
REPL via =(require 'thi.ng.sema... :reload)= or similar.
...
The autogenerated namespace =thi.ng.sema.version= contains a single
symbol =version= holding the version string defined above:

#+BEGIN_SRC clojure :noweb yes
  (use '[thi.ng.sema.version])
...
#+BEGIN_SRC clojure :tangle ../babel/src/cljx/thi/ng/sema/version.cljx :noweb yes :mkdirp yes :padline no :exports none
  (ns thi.ng.sema.version)
...
source files via the normal [[https://github.com/thi-ng/sema/tree/master/][GH repo browser]].
