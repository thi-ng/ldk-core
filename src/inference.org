...
* Namespace: thi.ng.sema.inference
...
#+BEGIN_SRC clojure :tangle ../babel/src/cljx/thi/ng/sema/inference/core.cljx :mkdirp yes :padline no
  (ns thi.ng.sema.inference.core
    (:require
